    ...
    private val loadResultsReceiver: BroadcastReceiver = object :
        ...
        override fun onReceive(context: Context, intent: Intent) {
            when (intent.getStringExtra(DETAILS_LOAD_RESULT_EXTRA)) {
                DETAILS_INTENT_EMPTY_EXTRA -> toUser(DETAILS_INTENT_EMPTY_EXTRA)
                DETAILS_DATA_EMPTY_EXTRA -> toUser(DETAILS_DATA_EMPTY_EXTRA)
                DETAILS_RESPONSE_EMPTY_EXTRA -> toUser(DETAILS_RESPONSE_EMPTY_EXTRA)
                DETAILS_REQUEST_ERROR_EXTRA -> toUser(DETAILS_REQUEST_ERROR_EXTRA)

                DETAILS_REQUEST_ERROR_MESSAGE_EXTRA -> toUser(DETAILS_REQUEST_ERROR_MESSAGE_EXTRA)
                DETAILS_URL_MALFORMED_EXTRA -> toUser(DETAILS_URL_MALFORMED_EXTRA)
                ...
                else -> toUser("Произошла ошибка")
            }
        }
    }

    fun toUser(message: String){
        StringBuilder().apply {
